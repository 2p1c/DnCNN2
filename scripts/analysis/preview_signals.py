...
def main():
    ...
    # Signal parameters
    parser.add_argument(
        "--num_samples", type=int, default=6, help="Number of samples to visualize"
    )
    parser.add_argument(
    ...
    parser.add_argument(
        "--no_show", action="store_true", help="Do not display plot (just save)"
    )
    parser.add_argument(
        "--detailed",
        action="store_true",
